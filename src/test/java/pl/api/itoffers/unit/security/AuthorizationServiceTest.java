...
public class AuthorizationServiceTest {
  ...
  public void setup() {
    ...
    this.service =
        new AuthorizationService(
            new UserInMemoryRepository(), this.jwtService, new BCryptPasswordEncoder());
  }
  ...
  public void testShouldGenerateTokenForUserThatExists() {
    ...
    String token =
        service.getToken(UserInMemoryRepository.EMAIL_USER, UserInMemoryRepository.PASSWORD_USER);
