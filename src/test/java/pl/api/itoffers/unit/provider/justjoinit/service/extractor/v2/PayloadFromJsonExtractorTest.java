...
public class PayloadFromJsonExtractorTest {
    ...
    @Test
    public void testShouldCorrectlyExtractOffersFromJsonThatHaveMultipleQueriesElements() throws IOException {
        String jjitJson = this.fileManager.readFile(JustJoinItParams.ALL_LOCATIONS_PAYLOAD_B2_DECEMBER_PATH_JSON);
