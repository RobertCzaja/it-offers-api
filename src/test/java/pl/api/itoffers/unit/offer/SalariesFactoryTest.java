...
public class SalariesFactoryTest {
  ...
  public void shouldCreateSalaries() {
    JustJoinItRawOffer rawJJITOffer =
        builder.salary("b2b", "pln", 25000, 32000, 25000D, 32000D).build();
  ...
  @Test
  public void
      whenSalaryHasDifferentCurrencyThanPLNItShouldCreatedSalaryInOriginalCurrencyAndInPLN() {
    JustJoinItRawOffer rawJJITOffer =
        builder.salary("b2b", "eur", 4500, 7000, 19256.852, 29955.102).build();
  ...
  @Test
  public void
      shouldAbortExecutionWhenThereIsNoKeyThatHoldsTheEmploymentDataReturnedFromJJITProvider() {
